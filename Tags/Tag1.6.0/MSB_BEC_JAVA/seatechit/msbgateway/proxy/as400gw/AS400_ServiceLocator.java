...
public class AS400_ServiceLocator extends org.apache.axis.client.Service implements seatechit.msbgateway.proxy.as400gw.AS400_Service {
	...
	private java.lang.String AS400HttpPort_address = "http://10.0.2.51/OneConnectServices/services/AS400";
	...
	public seatechit.msbgateway.proxy.as400gw.AS400_PortType getAS400HttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			seatechit.msbgateway.proxy.as400gw.AS400HttpBindingStub _stub = new seatechit.msbgateway.proxy.as400gw.AS400HttpBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (seatechit.msbgateway.proxy.as400gw.AS400_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
				seatechit.msbgateway.proxy.as400gw.AS400HttpBindingStub _stub = new seatechit.msbgateway.proxy.as400gw.AS400HttpBindingStub(new java.net.URL(AS400HttpPort_address), this);
				_stub.setPortName(getAS400HttpPortWSDDServiceName());
				return _stub;
			}
