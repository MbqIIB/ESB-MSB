...
public class Messages implements java.io.Serializable {
	...
	public Messages(java.lang.String[] arrString, java.lang.String description, java.lang.String errCode) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.arrString == null && other.getArrString() == null) || (this.arrString != null && java.util.Arrays.equals(this.arrString, other.getArrString())))
				&& ((this.description == null && other.getDescription() == null) || (this.description != null && this.description.equals(other.getDescription())))
				&& ((this.errCode == null && other.getErrCode() == null) || (this.errCode != null && this.errCode.equals(other.getErrCode())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getArrString() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getArrString()); i++) {
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(Messages.class, true);
