...
// Source File Name:   DSP16351RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP16351RPackager extends DSPPackager
{

    public DSP16351RPackager()
    {
    }
    ...
    public void declare()
    {
        DSPField fld[] = null;
        fld = (new DSPField[] {
            new DSPPackedField(10, 0, "Description for field 1"), new DSPCharField(40, "Description for field 2"), new DSPCharField(10, "Description for field 3"), new DSPCharField(10, "Description for field 4"), new DSPCharField(20, "Description for field 5"), new DSPPackedField(7, 0, "Description for field 6"), new DSPPackedField(7, 0, "Description for field 7"), new DSPPackedField(7, 0, "Description for field 8"), new DSPPackedField(7, 0, "Description for field 9"), new DSPPackedField(7, 0, "Description for field 10"), 
            new DSPPackedField(7, 0, "Description for field 11"), new DSPPackedField(7, 0, "Description for field 12"), new DSPPackedField(7, 0, "Description for field 13"), new DSPPackedField(7, 0, "Description for field 14"), new DSPPackedField(7, 0, "Description for field 15"), new DSPPackedField(7, 0, "Description for field 16"), new DSPPackedField(7, 0, "Description for field 17"), new DSPPackedField(3, 0, "Description for field 18"), new DSPPackedField(3, 0, "Description for field 19"), new DSPPackedField(3, 0, "Description for field 20"), 
            new DSPPackedField(4, 0, "Description for field 21"), new DSPPackedField(4, 0, "Description for field 22"), new DSPPackedField(4, 0, "Description for field 23"), new DSPPackedField(4, 0, "Description for field 24"), new DSPPackedField(4, 0, "Description for field 25"), new DSPPackedField(4, 0, "Description for field 26"), new DSPPackedField(7, 0, "Description for field 27"), new DSPPackedField(7, 0, "Description for field 28"), new DSPPackedField(7, 0, "Description for field 29"), new DSPPackedField(7, 0, "Description for field 30"), 
            ...
            new DSPPackedField(7, 0, "Description for field 51"), new DSPPackedField(7, 0, "Description for field 52"), new DSPPackedField(7, 0, "Description for field 53"), new DSPPackedField(7, 0, "Description for field 54"), new DSPPackedField(7, 0, "Description for field 55"), new DSPPackedField(7, 0, "Description for field 56"), new DSPPackedField(7, 0, "Description for field 57"), new DSPPackedField(7, 0, "Description for field 58"), new DSPPackedField(7, 0, "Description for field 59"), new DSPPackedField(7, 0, "Description for field 60"), 
            ...
            new DSPPackedField(7, 0, "Description for field 81"), new DSPPackedField(7, 0, "Description for field 82"), new DSPPackedField(7, 0, "Description for field 83"), new DSPPackedField(3, 0, "Description for field 84"), new DSPCharField(40, "Description for field 85"), new DSPCharField(40, "Description for field 86"), new DSPCharField(40, "Description for field 87"), new DSPCharField(3, "Description for field 88"), new DSPCharField(40, "Description for field 89")
        });
        addBody("16351R".toUpperCase(), fld);
    }
}
