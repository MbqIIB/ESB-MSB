...
// Source File Name:   DSP16352RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP16352RPackager extends DSPPackager
{

    public DSP16352RPackager()
    {
    }
    ...
    public void declare()
    {
        DSPField fld[] = null;
        fld = (new DSPField[] {
            new DSPPackedField(10, 0, "Description for field 1"), new DSPCharField(1, "Description for field 2"), new DSPPackedField(3, 0, "Description for field 3"), new DSPPackedField(10, 0, "Description for field 4"), new DSPCharField(40, "Description for field 5"), new DSPPackedField(4, 0, "Description for field 6"), new DSPPackedField(9, 2, "Description for field 7"), new DSPPackedField(7, 0, "Description for field 8"), new DSPPackedField(7, 0, "Description for field 9"), new DSPPackedField(7, 0, "Description for field 10"), 
            new DSPPackedField(6, 9, "Description for field 11"), new DSPCharField(3, "Description for field 12"), new DSPCharField(20, "Description for field 13"), new DSPPackedField(4, 0, "Description for field 14"), new DSPCharField(20, "Description for field 15"), new DSPPackedField(7, 0, "Description for field 16"), new DSPPackedField(7, 0, "Description for field 17"), new DSPPackedField(7, 0, "Description for field 18"), new DSPPackedField(7, 0, "Description for field 19"), new DSPPackedField(7, 0, "Description for field 20"), 
            ...
            new DSPPackedField(7, 0, "Description for field 51"), new DSPPackedField(3, 0, "Description for field 52"), new DSPPackedField(3, 0, "Description for field 53"), new DSPPackedField(3, 0, "Description for field 54"), new DSPPackedField(7, 0, "Description for field 55"), new DSPPackedField(7, 0, "Description for field 56"), new DSPPackedField(7, 0, "Description for field 57"), new DSPPackedField(7, 0, "Description for field 58"), new DSPPackedField(7, 0, "Description for field 59"), new DSPPackedField(7, 0, "Description for field 60"), 
            ...
            new DSPPackedField(7, 0, "Description for field 81"), new DSPPackedField(3, 0, "Description for field 82")
        });
        addBody("16352R".toUpperCase(), fld);
    }
}
