...
// Source File Name:   DSP18351RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP18351RPackager extends DSPPackager
{

    public DSP18351RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(7, 0, "Description for field 81"), new DSPPackedField(7, 0, "Description for field 82"), new DSPPackedField(7, 0, "Description for field 83"), new DSPPackedField(3, 0, "Description for field 84"), new DSPCharField(40, "Description for field 85")
        });
        addBody("18351R".toUpperCase(), fld);
    }
}
