...
// Source File Name:   DSP36520RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP36520RPackager extends DSPPackager
{

    public DSP36520RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(8, 2, "Description for field 11"), new DSPPackedField(4, 0, "Description for field 12"), new DSPPackedField(6, 0, "Description for field 13"), new DSPCharField(10, "Description for field 14"), new DSPCharField(20, "Description for field 15"), new DSPCharField(50, "Description for field 16"), new DSPCharField(50, "Description for field 17"), new DSPCharField(50, "Description for field 18"), new DSPCharField(50, "Description for field 19"), new DSPCharField(1, "Description for field 20"), 
            new DSPPackedField(10, 0, "Description for field 21"), new DSPPackedField(5, 0, "Description for field 22"), new DSPCharField(10, "Description for field 23"), new DSPCharField(20, "Description for field 24")
        });
        addBody("36520R".toUpperCase(), fld);
    }
}
