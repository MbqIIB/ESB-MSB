...
// Source File Name:   DSP55820RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP55820RPackager extends DSPPackager
{

    public DSP55820RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(7, 0, "Description for field 11")
        });
        addBody("55820R".toUpperCase(), fld);
    }
}
