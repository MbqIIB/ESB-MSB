...
// Source File Name:   DSP58630RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP58630RPackager extends DSPPackager
{

    public DSP58630RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(9, 2, "Description for field 11"), new DSPCharField(8, "Description for field 12"), new DSPPackedField(2, 0, "Description for field 13")
        });
        addBody("58630R".toUpperCase(), fld);
    }
}
