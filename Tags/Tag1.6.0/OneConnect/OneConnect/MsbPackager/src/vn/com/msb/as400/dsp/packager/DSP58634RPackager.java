...
// Source File Name:   DSP58634RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP58634RPackager extends DSPPackager
{

    public DSP58634RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(8, 5, "Description for field 21"), new DSPCharField(10, "Description for field 22"), new DSPPackedField(8, 2, "Description for field 23"), new DSPPackedField(9, 2, "Description for field 24"), new DSPPackedField(9, 2, "Description for field 25")
        });
        addBody("58634R".toUpperCase(), fld);
    }
}
