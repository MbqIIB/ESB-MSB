...
// Source File Name:   DSP83503RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP83503RPackager extends DSPPackager
{

    public DSP83503RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(1, "Description for field 11"), new DSPCharField(1, "Description for field 12"), new DSPCharField(1, "Description for field 13"), new DSPCharField(1, "Description for field 14"), new DSPCharField(1, "Description for field 15"), new DSPCharField(1, "Description for field 16"), new DSPPackedField(3, 0, "Description for field 17"), new DSPPackedField(10, 0, "Description for field 18"), new DSPCharField(10, "Description for field 19"), new DSPCharField(4, "Description for field 20"), 
            new DSPCharField(20, "Description for field 21"), new DSPCharField(1, "Description for field 22"), new DSPCharField(1, "Description for field 23"), new DSPCharField(1, "Description for field 24"), new DSPCharField(1, "Description for field 25"), new DSPCharField(1, "Description for field 26")
        });
        addBody("83503R".toUpperCase(), fld);
    }
}
