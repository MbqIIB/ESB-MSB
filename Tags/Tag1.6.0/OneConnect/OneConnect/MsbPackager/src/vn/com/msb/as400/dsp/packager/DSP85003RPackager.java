...
// Source File Name:   DSP85003RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP85003RPackager extends DSPPackager
{

    public DSP85003RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(1, "Description for field 11"), new DSPPackedField(2, 0, "Description for field 12"), new DSPCharField(2, "Description for field 13")
        });
        addBody("85003R".toUpperCase(), fld);
    }
}
