...
// Source File Name:   DSP86547RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP86547RPackager extends DSPPackager
{

    public DSP86547RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(8, 2, "Description for field 11"), new DSPPackedField(4, 0, "Description for field 12"), new DSPPackedField(6, 0, "Description for field 13"), new DSPPackedField(2, 0, "Description for field 14")
        });
        addBody("86547R".toUpperCase(), fld);
    }
}
