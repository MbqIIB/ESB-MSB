...
// Source File Name:   DSP94Packager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP94Packager extends DSPPackager
{

    public DSP94Packager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(7, 7, "Description for field 11"), new DSPCharField(4, "Description for field 12")
        });
        addBody("94".toUpperCase(), fld);
    }
}
