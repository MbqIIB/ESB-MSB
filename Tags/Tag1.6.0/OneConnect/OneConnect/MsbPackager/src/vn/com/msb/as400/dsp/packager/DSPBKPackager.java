...
// Source File Name:   DSPBKPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPBKPackager extends DSPPackager
{

    public DSPBKPackager()
    {
    }
    ...
    public void declare()
    {
        DSPField fld[] = null;
        fld = (new DSPField[] {
            new DSPPackedField(2, 0, "Description for field 1"), new DSPCharField(2, "Description for field 2"), new DSPPackedField(10, 0, "Description for field 3"), new DSPCharField(1, "Description for field 4"), new DSPPackedField(10, 0, "Description for field 5"), new DSPPackedField(5, 0, "Description for field 6"), new DSPCharField(2, "Description for field 7"), new DSPCharField(1, "Description for field 8"), new DSPCharField(10, "Description for field 9"), new DSPPackedField(2, 0, "Description for field 10"), 
            ...
            new DSPCharField(3, "Description for field 21"), new DSPCharField(10, "Description for field 22"), new DSPPackedField(4, 0, "Description for field 23"), new DSPPackedField(4, 0, "Description for field 24"), new DSPPackedField(3, 0, "Description for field 25"), new DSPPackedField(6, 9, "Description for field 26"), new DSPCharField(20, "Description for field 27"), new DSPPackedField(8, 2, "Description for field 28"), new DSPPackedField(1, 0, "Description for field 29"), new DSPCharField(1, "Description for field 30"), 
            new DSPCharField(1, "Description for field 31")
        });
        addBody("BK".toUpperCase(), fld);
    }
}
