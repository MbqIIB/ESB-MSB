...
// Source File Name:   DSPLN22PPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPLN22PPackager extends DSPPackager
{

    public DSPLN22PPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(19, "Description for field 21"), new DSPCharField(7, "Description for field 22"), new DSPCharField(13, "Description for field 23"), new DSPCharField(1, "Description for field 24"), new DSPCharField(1, "Description for field 25")
        });
        addBody("LN22P".toUpperCase(), fld);
    }
}
