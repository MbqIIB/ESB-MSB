...
// Source File Name:   DSPRMISSPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPRMISSPackager extends DSPPackager
{

    public DSPRMISSPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(2, 0, "Description for field 21"), new DSPPackedField(10, 0, "Description for field 22"), new DSPCharField(40, "Description for field 23"), new DSPCharField(15, "Description for field 24"), new DSPCharField(40, "Description for field 25"), new DSPCharField(40, "Description for field 26"), new DSPCharField(40, "Description for field 27"), new DSPCharField(15, "Description for field 28"), new DSPCharField(15, "Description for field 29"), new DSPCharField(40, "Description for field 30"), 
            new DSPCharField(15, "Description for field 31"), new DSPCharField(4, "Description for field 32"), new DSPCharField(3, "Description for field 33"), new DSPCharField(4, "Description for field 34"), new DSPCharField(15, "Description for field 35"), new DSPPackedField(8, 2, "Description for field 36"), new DSPPackedField(8, 2, "Description for field 37"), new DSPPackedField(8, 2, "Description for field 38"), new DSPPackedField(8, 2, "Description for field 39"), new DSPPackedField(8, 2, "Description for field 40"), 
            new DSPPackedField(10, 0, "Description for field 41"), new DSPPackedField(8, 2, "Description for field 42"), new DSPPackedField(10, 0, "Description for field 43"), new DSPPackedField(8, 2, "Description for field 44"), new DSPPackedField(9, 2, "Description for field 45"), new DSPPackedField(8, 2, "Description for field 46"), new DSPPackedField(8, 2, "Description for field 47"), new DSPPackedField(8, 2, "Description for field 48"), new DSPPackedField(2, 0, "Description for field 49"), new DSPPackedField(7, 7, "Description for field 50"), 
            new DSPCharField(4, "Description for field 51"), new DSPPackedField(2, 0, "Description for field 52"), new DSPPackedField(3, 0, "Description for field 53"), new DSPPackedField(4, 0, "Description for field 54")
        });
        addBody("RMISS".toUpperCase(), fld);
    }
}
