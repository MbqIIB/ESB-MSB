...
// Source File Name:   DSP16607RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP16607RPackager extends DSPPackager
{

    public DSP16607RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(2, 0, "Description for field 21"), new DSPPackedField(2, 0, "Description for field 22"), new DSPPackedField(2, 0, "Description for field 23")
        });
        addBody("16607R".toUpperCase(), fld);
    }
}
