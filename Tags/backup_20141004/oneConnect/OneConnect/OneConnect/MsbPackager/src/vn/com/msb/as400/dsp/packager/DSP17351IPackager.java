...
// Source File Name:   DSP17351IPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP17351IPackager extends DSPPackager
{

    public DSP17351IPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(7, 0, "Description for field 81"), new DSPPackedField(7, 0, "Description for field 82"), new DSPPackedField(7, 0, "Description for field 83"), new DSPPackedField(3, 0, "Description for field 84")
        });
        addBody("17351I".toUpperCase(), fld);
    }
}
