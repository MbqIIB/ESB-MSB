...
// Source File Name:   DSP18102RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP18102RPackager extends DSPPackager
{

    public DSP18102RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(40, "Description for field 101"), new DSPCharField(40, "Description for field 102"), new DSPCharField(3, "Description for field 103"), new DSPPackedField(5, 0, "Description for field 104"), new DSPPackedField(5, 0, "Description for field 105"), new DSPCharField(2, "Description for field 106"), new DSPCharField(4, "Description for field 107"), new DSPCharField(4, "Description for field 108"), new DSPCharField(4, "Description for field 109"), new DSPCharField(2, "Description for field 110"), 
            new DSPCharField(4, "Description for field 111"), new DSPCharField(4, "Description for field 112"), new DSPCharField(4, "Description for field 113")
        });
        addBody("18102R".toUpperCase(), fld);
    }
}
