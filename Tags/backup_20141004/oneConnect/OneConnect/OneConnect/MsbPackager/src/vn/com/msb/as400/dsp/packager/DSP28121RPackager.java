...
// Source File Name:   DSP28121RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP28121RPackager extends DSPPackager
{

    public DSP28121RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(8, 2, "Description for field 21"), new DSPPackedField(8, 2, "Description for field 22"), new DSPPackedField(10, 0, "Description for field 23"), new DSPCharField(40, "Description for field 24"), new DSPCharField(50, "Description for field 25"), new DSPPackedField(3, 0, "Description for field 26"), new DSPPackedField(5, 0, "Description for field 27"), new DSPCharField(4, "Description for field 28"), new DSPCharField(4, "Description for field 29"), new DSPPackedField(3, 0, "Description for field 30"), 
            new DSPPackedField(8, 2, "Description for field 31"), new DSPPackedField(9, 2, "Description for field 32"), new DSPCharField(2, "Description for field 33")
        });
        addBody("28121R".toUpperCase(), fld);
    }
}
