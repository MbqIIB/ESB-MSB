...
public class DSP68305RPackager extends DSPPackager {

	public DSP68305RPackager() {
	}
	...
	public void declare() {
		...
		fld = (new DSPField[] {
				...
				new DSPCharField(12, "Description for field 4"),
				new DSPPackedField(3, 0, "Description for field 5"),
				new DSPCharField(3, "Description for field 6"),
				new DSPCharField(20, "Description for field 7")
				});
		addBody("68305R".toUpperCase(), fld);
	}
}
