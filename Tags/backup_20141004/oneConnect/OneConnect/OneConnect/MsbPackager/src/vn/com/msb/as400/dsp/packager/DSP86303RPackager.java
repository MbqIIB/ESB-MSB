...
// Source File Name:   DSP86303RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP86303RPackager extends DSPPackager
{

    public DSP86303RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(8, 2, "Description for field 61"), new DSPCharField(3, "Description for field 62"), new DSPPackedField(8, 2, "Description for field 63"),new DSPPackedField(4, 4, "Description for field 64"),new DSPPackedField(3, 2, "Description for field 65")
        });
        addBody("86303R".toUpperCase(), fld);
    }
}
