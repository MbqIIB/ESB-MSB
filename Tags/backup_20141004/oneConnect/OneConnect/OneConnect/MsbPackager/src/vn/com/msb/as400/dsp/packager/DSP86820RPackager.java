...
// Source File Name:   DSP86820RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP86820RPackager extends DSPPackager
{

    public DSP86820RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(7, 2, "Description for field 41"), new DSPPackedField(9, 5, "Description for field 42"), new DSPPackedField(9, 5, "Description for field 43"), new DSPPackedField(8, 5, "Description for field 44"), new DSPPackedField(8, 5, "Description for field 45"), new DSPPackedField(8, 2, "Description for field 46"), new DSPPackedField(7, 2, "Description for field 47"), new DSPPackedField(7, 2, "Description for field 48"), new DSPPackedField(7, 2, "Description for field 49"), new DSPPackedField(7, 2, "Description for field 50"), 
            new DSPPackedField(9, 5, "Description for field 51"), new DSPPackedField(9, 5, "Description for field 52"), new DSPPackedField(8, 5, "Description for field 53"), new DSPPackedField(8, 5, "Description for field 54")
        });
        addBody("86820R".toUpperCase(), fld);
    }
}
