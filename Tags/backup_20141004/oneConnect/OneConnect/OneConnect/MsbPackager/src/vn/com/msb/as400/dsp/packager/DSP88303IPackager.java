...
// Source File Name:   DSP88303IPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP88303IPackager extends DSPPackager
{

    public DSP88303IPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(8, 2, "Description for field 61"), new DSPCharField(2, "Description for field 62"), new DSPPackedField(8, 2, "Description for field 63")
        });
        addBody("88303I".toUpperCase(), fld);
    }
}
