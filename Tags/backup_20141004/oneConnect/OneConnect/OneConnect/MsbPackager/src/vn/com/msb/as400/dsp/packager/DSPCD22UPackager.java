...
// Source File Name:   DSPCD22UPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPCD22UPackager extends DSPPackager
{

    public DSPCD22UPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(6, 2, "Description for field 21"), new DSPPackedField(6, 2, "Description for field 22"), new DSPCharField(15, "Description for field 23"), new DSPPackedField(6, 2, "Description for field 24"), new DSPPackedField(6, 2, "Description for field 25"), new DSPPackedField(4, 0, "Description for field 26"), new DSPPackedField(5, 2, "Description for field 27"), new DSPPackedField(5, 2, "Description for field 28"), new DSPPackedField(5, 2, "Description for field 29"), new DSPPackedField(6, 0, "Description for field 30"), 
            new DSPCharField(1, "Description for field 31")
        });
        addBody("CD22U".toUpperCase(), fld);
    }
}
