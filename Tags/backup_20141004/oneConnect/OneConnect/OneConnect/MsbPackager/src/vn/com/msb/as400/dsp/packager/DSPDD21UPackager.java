...
// Source File Name:   DSPDD21UPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPDD21UPackager extends DSPPackager
{

    public DSPDD21UPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(6, 2, "Description for field 31"), new DSPPackedField(6, 2, "Description for field 32"), new DSPPackedField(6, 2, "Description for field 33"), new DSPPackedField(6, 2, "Description for field 34"), new DSPPackedField(5, 2, "Description for field 35"), new DSPPackedField(5, 2, "Description for field 36"), new DSPPackedField(2, 0, "Description for field 37"), new DSPCharField(2, "Description for field 38"), new DSPPackedField(2, 0, "Description for field 39"), new DSPPackedField(2, 0, "Description for field 40"), 
            new DSPCharField(2, "Description for field 41"), new DSPCharField(1, "Description for field 42"), new DSPCharField(2, "Description for field 43"), new DSPPackedField(1, 0, "Description for field 44"), new DSPCharField(1, "Description for field 45"), new DSPCharField(1, "Description for field 46"), new DSPCharField(1, "Description for field 47"), new DSPCharField(1, "Description for field 48"), new DSPCharField(1, "Description for field 49"), new DSPPackedField(4, 6, "Description for field 50"), 
            new DSPPackedField(4, 6, "Description for field 51"), new DSPPackedField(4, 6, "Description for field 52"), new DSPPackedField(4, 6, "Description for field 53"), new DSPCharField(1, "Description for field 54"), new DSPPackedField(6, 2, "Description for field 55"), new DSPPackedField(6, 2, "Description for field 56"), new DSPPackedField(6, 2, "Description for field 57"), new DSPPackedField(5, 2, "Description for field 58"), new DSPPackedField(5, 2, "Description for field 59"), new DSPCharField(1, "Description for field 60"), 
            new DSPCharField(1, "Description for field 61"), new DSPCharField(1, "Description for field 62"), new DSPPackedField(6, 2, "Description for field 63"), new DSPPackedField(4, 0, "Description for field 64"), new DSPCharField(15, "Description for field 65"), new DSPCharField(1, "Description for field 66")
        });
        addBody("DD21U".toUpperCase(), fld);
    }
}
