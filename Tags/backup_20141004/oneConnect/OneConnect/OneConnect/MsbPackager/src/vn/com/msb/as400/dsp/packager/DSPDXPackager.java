...
// Source File Name:   DSPDXPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPDXPackager extends DSPPackager
{

    public DSPDXPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(4, "Description for field 11"), new DSPCharField(40, "Description for field 12")
        });
        addBody("DX".toUpperCase(), fld);
    }
}
