...
// Source File Name:   DSPLN25UPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPLN25UPackager extends DSPPackager
{

    public DSPLN25UPackager()
    {
    }
    ...
    public void declare()
    {
        DSPField fld[] = null;
        fld = (new DSPField[] {
            new DSPPackedField(2, 0, "Description for field 1"), new DSPCharField(1, "Description for field 2"), new DSPCharField(1, "Description for field 3"), new DSPCharField(1, "Description for field 4"), new DSPCharField(1, "Description for field 5"), new DSPCharField(15, "Description for field 6"), new DSPPackedField(6, 2, "Description for field 7"), new DSPPackedField(4, 6, "Description for field 8"), new DSPPackedField(4, 6, "Description for field 9"), new DSPPackedField(2, 0, "Description for field 10"), 
            new DSPPackedField(6, 2, "Description for field 11"), new DSPPackedField(5, 2, "Description for field 12"), new DSPCharField(20, "Description for field 13"), new DSPPackedField(2, 0, "Description for field 14"), new DSPPackedField(2, 0, "Description for field 15"), new DSPPackedField(2, 0, "Description for field 16"), new DSPPackedField(2, 0, "Description for field 17"), new DSPPackedField(2, 0, "Description for field 18"), new DSPPackedField(5, 0, "Description for field 19"), new DSPPackedField(4, 0, "Description for field 20"), 
            new DSPPackedField(6, 2, "Description for field 21"), new DSPPackedField(2, 0, "Description for field 22"), new DSPPackedField(4, 6, "Description for field 23"), new DSPCharField(1, "Description for field 24"), new DSPCharField(1, "Description for field 25"), new DSPPackedField(6, 2, "Description for field 26"), new DSPPackedField(6, 2, "Description for field 27"), new DSPPackedField(6, 2, "Description for field 28"), new DSPPackedField(6, 2, "Description for field 29"), new DSPPackedField(4, 0, "Description for field 30"), 
