...
// Source File Name:   DSPRMREMIQPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPRMREMIQPackager extends DSPPackager
{

    public DSPRMREMIQPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(2, 0, "Description for field 21")
        });
        addBody("RMREMIQ".toUpperCase(), fld);
    }
}
