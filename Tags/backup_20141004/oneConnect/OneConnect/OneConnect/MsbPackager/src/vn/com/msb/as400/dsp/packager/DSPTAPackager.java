...
// Source File Name:   DSPTAPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPTAPackager extends DSPPackager
{

    public DSPTAPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(30, "Description for field 11"), new DSPCharField(30, "Description for field 12"), new DSPCharField(3, "Description for field 13"), new DSPPackedField(4, 0, "Description for field 14"), new DSPCharField(40, "Description for field 15")
        });
        addBody("TA".toUpperCase(), fld);
    }
}
