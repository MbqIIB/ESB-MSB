...
import vn.com.m1tech.AS400.Factory.entity.LnRepayment_ABCS4102;
...
/**
 * @author Quanld
 * Thanh toan khoan vay ABCS 4102 RePaytransfer
 */
public class CBS077 extends AbTransferMsg implements ITransferMsg {
	@Override
	public void buildMessage(MbMessage inMessage, MbMessage outMessage,
		...
		LnRepayment_ABCS4102 lnRepayment = new LnRepayment_ABCS4102();
		lnRepayment.acc=transferAcc;
