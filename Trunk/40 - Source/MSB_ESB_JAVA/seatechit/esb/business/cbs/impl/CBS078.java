...
import vn.com.m1tech.AS400.Factory.entity.LnPaidOffCa_ABCS4920;
...
/**
 * @author Quanld
 * Tat toan Tai khoan ung von voi tai khoan thanh toan lnPaidoffCa
 */
public class CBS078 extends AbTransferMsg implements ITransferMsg {
	@Override
	public void buildMessage(MbMessage inMessage, MbMessage outMessage,
		...
		LnPaidOffCa_ABCS4920 paidOffCa = new LnPaidOffCa_ABCS4920();
