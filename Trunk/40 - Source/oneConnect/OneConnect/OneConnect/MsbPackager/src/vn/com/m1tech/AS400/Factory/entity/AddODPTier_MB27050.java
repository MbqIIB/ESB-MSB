...
public class AddODPTier_MB27050 extends IMessage {
	public OdpEntity odp=null;
	public AddODPTier_MB27050() {
		super(DSPPackager.PACKAGER_MBASE_27050I);
		// TODO Auto-generated constructor stub
	}
 //*LINX|10.2.142.79||||213||0200|*DSP|MBSD|*LINX||||01|||BBMBSDDMNTFNC|||||1|10|DD110047|RB|27050|N||||DD110047|1||*END||BTS|RBS||RB|27|110||||27050|A|R|1|N|F|||||||||||||||||11001017011089|D||ODP|100000000|100000000|000|000|12001|0.00|+|0.00|0.00|||021213|300414|R|D|000000||000|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||] End Of Record.
	@Override
	public String[] toArray() {
		...
		strValue[73] = "000";
		strValue[74] = "000";
		strValue[75] = odp.getOdRate(); // lãi suất thấu chi "12001"
