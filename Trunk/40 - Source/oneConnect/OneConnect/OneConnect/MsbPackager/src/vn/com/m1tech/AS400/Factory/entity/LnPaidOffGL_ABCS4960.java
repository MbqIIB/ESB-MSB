...
public class LnPaidOffGL_ABCS4960 extends IMessage {
	public LnPaidOffGL_ABCS4960 () {
...
//		192.168.56.1| | | |213|42|0200| |ABCS|*LINX| | | | | | |BBHTLMONEYFNC| | | | | | |DD110015|PC|4960| | | |3843|*MOSA| |192.168.56.1| | | | |T9999| ||DD110015|0003|N||||4960|300414| |VD|PC|MG110099|110|0|1|N|N|N|N|N|N|N|11082010037744|||89876700|||||280701001||||||||000|000|000|89876700|||||10000000|10000000|10000000|10000000|||VND||||||||||||VND|VND|VND|VND|VND||||3|||||||||||||1|4|4|2|||||||||||3|4|5||||6||||1||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||000||000|000||||||||89876700||||6||4|5||||||||2|||||||||||||||||||||000|000|||||||||1|1|||||||] End Of Record.
		...
		strValue[66] = acc.getDebitAmount(); // Comment for field 65 : Transfer
												// Amount
		...
		strValue[109] = acc.getAdviceNumber();
