...
public class DSPPackager {
	...
	static {
		...
		new DSP86562IPackager().declare();
		new DSP86562RPackager().declare();
		...
		new DSP88562IPackager().declare();
		new DSP88562RPackager().declare();
...
//	public static DSPPackager PACKAGER_MBASE_26162I;
	...
	//Gen Application No
	public static DSPPackager PACKAGER_MBASE_82301I;
	...
	//search all Facility
	//Lock AccLoan for app
	public static DSPPackager PACKAGER_MBASE_86562I;
	...
	// Lock AA by Approve
	public static DSPPackager PACKAGER_MBASE_86301I;
	...
	public static DSPPackager PACKAGER_MBASE_82303I;
	
	// LN Facility Maintenance - Officer
	public static DSPPackager PACKAGER_MBASE_85321I;
	
	
	// LN Account Maintenance
	public static DSPPackager PACKAGER_MBASE_82504I;
	
	// 
	public static DSPPackager PACKAGER_MBASE_85506I;
	
	
	public static DSPPackager PACKAGER_MBASE_85502I;
	
	
	public static DSPPackager PACKAGER_MBASE_82501I;
	
	public static DSPPackager PACKAGER_MBASE_88501I;
	
	public static DSPPackager PACKAGER_MBASE_83503I;

	public static DSPPackager PACKAGER_MBASE_88562I;
	...
	static {
		try {
			...
			// for gennarate App no
			PACKAGER_MBASE_82301I = createPackager("MBSD", "82301I");
			...
			// for search AA by cif
			PACKAGER_MBASE_86562I = createPackager("MBSD", "86562I");
			// For LN account inquiry
			...
			PACKAGER_MBASE_88301I = createPackager("MBSD", "88301I");
		
			// Packager for lock AA for Approve
			PACKAGER_MBASE_85301I = createPackager("MBSD", "85301I");
			
			PACKAGER_MBASE_88562I = createPackager("MBSD", "88562I");
			
			
			// Packager for lock AA for Approve
			PACKAGER_MBASE_86301I = createPackager("MBSD", "86301I");
			...
			// Packager for ATM card
			PACKAGER_MBASE_82303I = createPackager("MBSD", "82303I");
			
			
			PACKAGER_MBASE_85321I = createPackager("MBSD", "85321I");
			
			
			PACKAGER_MBASE_82504I = createPackager("MBSD", "82504I");
			
			PACKAGER_MBASE_85506I = createPackager("MBSD", "85506I");
			
			
			
			PACKAGER_MBASE_85502I = createPackager("MBSD", "85502I");
			
			
			PACKAGER_MBASE_82501I = createPackager("MBSD", "82501I");
			
			PACKAGER_MBASE_88501I = createPackager("MBSD", "88501I");
			
			
			PACKAGER_MBASE_83503I = createPackager("MBSD", "83503I");
		} catch (Exception ex) {
			ex.printStackTrace();
//			System.exit(-1);
		}
