...
// Source File Name:   DSP15109RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP15109RPackager extends DSPPackager {

	public DSP15109RPackager() {
	}
	...
	public void declare() {
		...
		fld = (new DSPField[] {
				...
				new DSPCharField(20, "Description for field 3"),
				new DSPCharField(40, "Description for field 4"),
				new DSPCharField(3, "Description for field 5"),
		...
		addBody("15109R".toUpperCase(), fld);
	}
}
