...
// Source File Name:   DSP15240RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP15240RPackager extends DSPPackager
{

    public DSP15240RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(4, 0, "Description for field 11"), new DSPCharField(40, "Description for field 12"), new DSPCharField(40, "Description for field 13"), new DSPCharField(20, "Description for field 14")
        });
        addBody("15240R".toUpperCase(), fld);
    }
}
