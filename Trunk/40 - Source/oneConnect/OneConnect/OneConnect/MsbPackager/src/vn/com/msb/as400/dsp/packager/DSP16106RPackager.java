...
// Source File Name:   DSP16106RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP16106RPackager extends DSPPackager
{

    public DSP16106RPackager()
    {
    }
    ...
    public void declare()
    {
        DSPField fld[] = null;
        fld = (new DSPField[] {
            new DSPPackedField(10, 0, "Description for field 1"), new DSPCharField(1, "Description for field 2"), new DSPPackedField(1, 0, "Description for field 3"), new DSPPackedField(2, 0, "Description for field 4"), new DSPPackedField(3, 0, "Description for field 5"), new DSPPackedField(3, 0, "Description for field 6"), new DSPPackedField(1, 0, "Description for field 7"), new DSPCharField(1, "Description for field 8"), new DSPCharField(10, "Description for field 9"), new DSPCharField(20, "Description for field 10"), 
            ...
            new DSPPackedField(1, 0, "Description for field 81"), new DSPPackedField(4, 0, "Description for field 82"), new DSPCharField(10, "Description for field 83"), new DSPCharField(10, "Description for field 84"), new DSPPackedField(4, 0, "Description for field 85"), new DSPCharField(2, "Description for field 86"), new DSPPackedField(4, 0, "Description for field 87"), new DSPCharField(1, "Description for field 88"), new DSPCharField(40, "Description for field 89"), new DSPCharField(40, "Description for field 90"), 
            new DSPCharField(40, "Description for field 91"), new DSPCharField(40, "Description for field 92"), new DSPCharField(30, "Description for field 93"), new DSPCharField(30, "Description for field 94"), new DSPCharField(30, "Description for field 95"), new DSPPackedField(4, 0, "Description for field 96"), new DSPCharField(3, "Description for field 97"), new DSPCharField(40, "Description for field 98"), new DSPCharField(20, "Description for field 99"), new DSPCharField(40, "Description for field 100"), 
            new DSPCharField(40, "Description for field 101"), new DSPCharField(40, "Description for field 102"), new DSPCharField(40, "Description for field 103"), new DSPPackedField(5, 0, "Description for field 104"), new DSPPackedField(5, 0, "Description for field 105"), new DSPCharField(1, "Description for field 106"), new DSPCharField(32, "Description for field 107"), new DSPCharField(32, "Description for field 108"), new DSPCharField(32, "Description for field 109"), new DSPCharField(32, "Description for field 110"), 
            ...
            new DSPCharField(32, "Description for field 121"), new DSPCharField(32, "Description for field 122"), new DSPCharField(2, "Description for field 123"), new DSPCharField(4, "Description for field 124"), new DSPCharField(4, "Description for field 125"), new DSPCharField(4, "Description for field 126"), new DSPCharField(2, "Description for field 127"), new DSPCharField(4, "Description for field 128"), new DSPCharField(4, "Description for field 129"), new DSPCharField(4, "Description for field 130")
        });
        addBody("16106R".toUpperCase(), fld);
    }
}
