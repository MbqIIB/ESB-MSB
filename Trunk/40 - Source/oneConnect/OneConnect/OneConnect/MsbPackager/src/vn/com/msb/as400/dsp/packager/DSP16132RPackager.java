...
// Source File Name:   DSP16132RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP16132RPackager extends DSPPackager
{

    public DSP16132RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(3, "Description for field 21"), new DSPCharField(1, "Description for field 22"), new DSPCharField(1, "Description for field 23"), new DSPPackedField(4, 0, "Description for field 24"), new DSPCharField(20, "Description for field 25")
        });
        addBody("16132R".toUpperCase(), fld);
    }
}
