...
// Source File Name:   DSP16382RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP16382RPackager extends DSPPackager
{

    public DSP16382RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(3, 5, "Description for field 61"), new DSPPackedField(4, 0, "Description for field 62"), new DSPPackedField(3, 0, "Description for field 63"), new DSPPackedField(3, 0, "Description for field 64"), new DSPPackedField(4, 0, "Description for field 65")
        });
        addBody("16382R".toUpperCase(), fld);
    }
}
