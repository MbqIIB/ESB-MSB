...
// Source File Name:   DSP17101RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP17101RPackager extends DSPPackager
{

    public DSP17101RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(1, 0, "Description for field 81"), new DSPPackedField(4, 0, "Description for field 82"), new DSPCharField(10, "Description for field 83"), new DSPCharField(10, "Description for field 84"), new DSPPackedField(4, 0, "Description for field 85")
        });
        addBody("17101R".toUpperCase(), fld);
    }
}
