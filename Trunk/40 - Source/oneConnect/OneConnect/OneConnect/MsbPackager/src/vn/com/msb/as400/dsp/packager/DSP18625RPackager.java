...
// Source File Name:   DSP18625RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP18625RPackager extends DSPPackager
{

    public DSP18625RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(3, "Description for field 21"), new DSPCharField(20, "Description for field 22"), new DSPCharField(9, "Description for field 23"), new DSPCharField(3, "Description for field 24"), new DSPPackedField(4, 0, "Description for field 25"), new DSPCharField(3, "Description for field 26"), new DSPCharField(1, "Description for field 27"), new DSPPackedField(4, 0, "Description for field 28"), new DSPCharField(3, "Description for field 29"), new DSPCharField(1, "Description for field 30"), 
            new DSPCharField(1, "Description for field 31"), new DSPCharField(4, "Description for field 32"), new DSPCharField(1, "Description for field 33"), new DSPCharField(40, "Description for field 34"), new DSPCharField(40, "Description for field 35"), new DSPCharField(2, "Description for field 36"), new DSPCharField(2, "Description for field 37"), new DSPCharField(2, "Description for field 38"), new DSPCharField(30, "Description for field 39"), new DSPCharField(30, "Description for field 40"), 
            new DSPCharField(30, "Description for field 41"), new DSPPackedField(2, 0, "Description for field 42"), new DSPPackedField(3, 0, "Description for field 43"), new DSPCharField(20, "Description for field 44"), new DSPCharField(3, "Description for field 45"), new DSPCharField(40, "Description for field 46"), new DSPCharField(40, "Description for field 47"), new DSPCharField(20, "Description for field 48"), new DSPCharField(20, "Description for field 49"), new DSPCharField(1, "Description for field 50"), 
            new DSPCharField(1, "Description for field 51"), new DSPPackedField(4, 0, "Description for field 52"), new DSPPackedField(5, 0, "Description for field 53"), new DSPPackedField(5, 0, "Description for field 54"), new DSPCharField(2, "Description for field 55"), new DSPCharField(4, "Description for field 56"), new DSPCharField(4, "Description for field 57"), new DSPCharField(4, "Description for field 58"), new DSPCharField(2, "Description for field 59"), new DSPCharField(4, "Description for field 60"), 
            new DSPCharField(4, "Description for field 61"), new DSPCharField(4, "Description for field 62"), new DSPCharField(1, "Description for field 63")
        });
        addBody("18625R".toUpperCase(), fld);
    }
}
