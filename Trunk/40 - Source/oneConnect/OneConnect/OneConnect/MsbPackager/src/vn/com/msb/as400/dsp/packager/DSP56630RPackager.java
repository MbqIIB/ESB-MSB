...
// Source File Name:   DSP56630RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP56630RPackager extends DSPPackager
{

    public DSP56630RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(5, 0, "Description for field 21")
        });
        addBody("56630R".toUpperCase(), fld);
    }
}
