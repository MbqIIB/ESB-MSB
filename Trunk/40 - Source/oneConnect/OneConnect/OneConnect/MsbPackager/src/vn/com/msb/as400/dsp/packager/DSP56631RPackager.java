...
// Source File Name:   DSP56631RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP56631RPackager extends DSPPackager
{

    public DSP56631RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(4, "Description for field 21"), new DSPPackedField(9, 2, "Description for field 22"), new DSPCharField(10, "Description for field 23")
        });
        addBody("56631R".toUpperCase(), fld);
    }
}
