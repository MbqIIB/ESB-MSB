...
// Source File Name:   DSP76450RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP76450RPackager extends DSPPackager
{

    public DSP76450RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(3, 0, "Description for field 11"), new DSPPackedField(9, 2, "Description for field 12"), new DSPPackedField(3, 0, "Description for field 13"), new DSPPackedField(9, 2, "Description for field 14")
        });
        addBody("76450R".toUpperCase(), fld);
    }
}
