...
// Source File Name:   DSP85831RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP85831RPackager extends DSPPackager
{

    public DSP85831RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(40, "Description for field 11"), new DSPCharField(4, "Description for field 12"), new DSPPackedField(6, 9, "Description for field 13"), new DSPCharField(10, "Description for field 14"), new DSPPackedField(3, 0, "Description for field 15"), new DSPCharField(1, "Description for field 16"), new DSPPackedField(4, 0, "Description for field 17"), new DSPPackedField(4, 0, "Description for field 18"), new DSPCharField(40, "Description for field 19"), new DSPPackedField(8, 2, "Description for field 20"), 
            ...
            new DSPPackedField(8, 2, "Description for field 31"), new DSPPackedField(8, 2, "Description for field 32")
        });
        addBody("85831R".toUpperCase(), fld);
    }
}
