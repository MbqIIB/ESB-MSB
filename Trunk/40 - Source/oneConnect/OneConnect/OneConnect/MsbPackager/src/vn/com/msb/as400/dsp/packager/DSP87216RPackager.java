...
// Source File Name:   DSP87216RPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP87216RPackager extends DSPPackager
{

    public DSP87216RPackager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(40, "Description for field 21"), new DSPCharField(40, "Description for field 22"), new DSPCharField(40, "Description for field 23"), new DSPCharField(40, "Description for field 24"), new DSPCharField(50, "Description for field 25"), new DSPPackedField(6, 9, "Description for field 26"), new DSPCharField(1, "Description for field 27"), new DSPPackedField(4, 0, "Description for field 28"), new DSPPackedField(4, 0, "Description for field 29"), new DSPPackedField(4, 0, "Description for field 30"), 
            new DSPPackedField(4, 0, "Description for field 31"), new DSPCharField(20, "Description for field 32"), new DSPCharField(4, "Description for field 33"), new DSPPackedField(4, 0, "Description for field 34"), new DSPPackedField(4, 0, "Description for field 35"), new DSPPackedField(4, 0, "Description for field 36"), new DSPPackedField(4, 0, "Description for field 37"), new DSPCharField(20, "Description for field 38"), new DSPCharField(4, "Description for field 39"), new DSPCharField(4, "Description for field 40"), 
            new DSPPackedField(4, 0, "Description for field 41"), new DSPPackedField(4, 0, "Description for field 42"), new DSPPackedField(4, 0, "Description for field 43"), new DSPPackedField(4, 0, "Description for field 44"), new DSPPackedField(4, 0, "Description for field 45"), new DSPPackedField(4, 0, "Description for field 46"), new DSPPackedField(8, 2, "Description for field 47"), new DSPPackedField(8, 2, "Description for field 48"), new DSPPackedField(8, 2, "Description for field 49")
        });
        addBody("87216R".toUpperCase(), fld);
    }
}
