...
// Source File Name:   DSP89V2Packager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSP89V2Packager extends DSPPackager
{

    public DSP89V2Packager()
    {
    }
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPPackedField(6, 2, "Description for field 31"), new DSPPackedField(6, 2, "Description for field 32"), new DSPPackedField(6, 2, "Description for field 33"), new DSPPackedField(6, 2, "Description for field 34"), new DSPPackedField(6, 2, "Description for field 35"), new DSPPackedField(6, 2, "Description for field 36"), new DSPPackedField(6, 2, "Description for field 37"), new DSPPackedField(6, 2, "Description for field 38"), new DSPPackedField(4, 0, "Description for field 39"), new DSPPackedField(6, 2, "Description for field 40"), 
            new DSPPackedField(3, 0, "Description for field 41"), new DSPPackedField(6, 2, "Description for field 42"), new DSPCharField(1, "Description for field 43"), new DSPPackedField(6, 2, "Description for field 44"), new DSPCharField(1, "Description for field 45"), new DSPCharField(1, "Description for field 46"), new DSPCharField(1, "Description for field 47"), new DSPCharField(1, "Description for field 48"), new DSPPackedField(6, 2, "Description for field 49")
        });
        addBody("89V2".toUpperCase(), fld);
    }
}
