...
// Source File Name:   DSPIPackager.java

package vn.com.msb.as400.dsp.packager;

import vn.com.msb.as400.dsp.*;

public class DSPIPackager extends DSPPackager
{
    ...
    public void declare()
    {
        ...
        fld = (new DSPField[] {
            ...
            new DSPCharField(3, "Description for field 21"), new DSPPackedField(3, 0, "Description for field 22"), new DSPPackedField(4, 0, "Description for field 23"), new DSPPackedField(4, 0, "Description for field 24"), new DSPPackedField(3, 0, "Description for field 25"), new DSPPackedField(6, 9, "Description for field 26"), new DSPCharField(20, "Description for field 27"), new DSPPackedField(8, 2, "Description for field 28")
        });
        addBody("I".toUpperCase(), fld);
    }
}
